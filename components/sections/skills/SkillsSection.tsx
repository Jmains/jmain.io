    ...
    <section id="skillsSection">
      <div className="grid grid-cols-1 mx-4 md:grid-cols-1 lg:grid-cols-1 border-l border-r border-gray-200 md:border-none pt-10 pb-16 lg:pb-32 lg:pt-16">
        ...
        <div className="mt-10 lg:mt-0 md:pt-6 lg:pt-20 px-4 sm:px-10">
          <h3 className="text-gray-800 border-l-4 -ml-5 sm:-ml-11 sm:px-9 border-primaryDark md:border-none px-4 tracking-wide md:text-left sm:text-lg lg:text-2xl font-medium">
            Languages
          </h3>
        ...
        <div className=" lg:mt-0 pt-10 px-4 sm:px-10">
          <h3 className="text-gray-800 border-l-4 -ml-5 sm:-ml-11 sm:px-9 border-primaryDark md:border-none px-4 tracking-wide md:text-left mt-10 sm:text-lg lg:text-2xl font-medium">
