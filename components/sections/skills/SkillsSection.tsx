...
const SkillsSection: FC<Props> = () => {
  return (
    <section className="p-4 lg:px-16 pb-16 text-center lg:text-left">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 lg:text-left">
        <div className="mt-10">
          <h3 className="text-gray-700 tracking-wide">Languages</h3>
          <div className="grid grid-cols-3 md:grid-cols-3 grid-flow-row mt-10 gap-y-16">
        ...
        <div className="mt-10">
          <h3 className="text-gray-700 tracking-wide">Tools & Databases</h3>
